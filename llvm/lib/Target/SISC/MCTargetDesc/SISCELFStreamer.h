//===-- SISCELFStreamer.h - SISC ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_SISC_SISCELFSTREAMER_H
#define LLVM_LIB_TARGET_SISC_SISCELFSTREAMER_H
...
class SISCTargetELFStreamer : public SISCTargetStreamer {
private:
...
public:
  ...
  SISCTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
