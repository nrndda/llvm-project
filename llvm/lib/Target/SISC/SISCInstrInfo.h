//===-- SISCInstrInfo.h - SISC Instruction Information --------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_SISC_SISCINSTRINFO_H
#define LLVM_LIB_TARGET_SISC_SISCINSTRINFO_H
...
class SISCInstrInfo : public SISCGenInstrInfo {

public:
  explicit SISCInstrInfo(SISCSubtarget &STI);
...
namespace SISC {
// Match with the definitions in SISCInstrFormatsV.td
