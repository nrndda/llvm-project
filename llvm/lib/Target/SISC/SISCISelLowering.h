//===-- SISCISelLowering.h - SISC DAG Lowering Interface ------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_SISC_SISCISELLOWERING_H
#define LLVM_LIB_TARGET_SISC_SISCISELLOWERING_H
...
class SISCTargetLowering : public TargetLowering {
  const SISCSubtarget &Subtarget;

public:
  explicit SISCTargetLowering(const TargetMachine &TM,
