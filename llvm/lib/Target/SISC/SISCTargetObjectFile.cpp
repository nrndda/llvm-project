//===-- SISCTargetObjectFile.cpp - SISC Object Info -----------------===//
//
...
void SISCELFTargetObjectFile::Initialize(MCContext &Ctx,
...
bool SISCELFTargetObjectFile::isInSmallSection(uint64_t Size) const {
...
// section.
bool SISCELFTargetObjectFile::isGlobalInSmallSection(
...
MCSection *SISCELFTargetObjectFile::SelectSectionForGlobal(
...
void SISCELFTargetObjectFile::getModuleMetadata(Module &M) {
...
bool SISCELFTargetObjectFile::isConstantInSmallSection(
    const DataLayout &DL, const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *SISCELFTargetObjectFile::getSectionForConstant(
